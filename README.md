...
- **messageadder:**<br>
  ...
  messageadder.excheckerhsh2(hsh(filename),port) // same as exchecker but checks it by using the last 8 characters of the SHA256 hash of the saved filename<br>
   ...
   ## road map
 - [x] create the first demo
 - [ ] write script that can automatically generate nodes and manage them
 - [ ] create the public network edition
 - [ ] add sharding optimized file asking function for sharded blockchains
